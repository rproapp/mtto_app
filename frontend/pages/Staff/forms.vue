...
import CheckboxPicker from '@/components/Widgets/CheckboxPicker'
import RadioPicker from '@/components/Widgets/RadioPicker'
import FilePicker from '@/components/Widgets/FilePicker'
import HeroBar from '@/components/Widgets/HeroBar'
export default {
  name: 'Forms',
  components: {
    HeroBar,
